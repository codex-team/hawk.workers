...
import TelegramProvider from '../../src/providers/telegram/provider';
import templates from '../../src/providers/telegram/templates';
import EventTpl from '../../src/providers/telegram/templates/event';
